...
export default async function Contact() {
  return (
    <section className="relative z-10 overflow-hidden bg-white">
      <div className="bg-center bg-cover h-[300px] md:h-[390px] bg-[url('https://images.unsplash.com/photo-1484807352052-23338990c6c6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80')]">
      ...
      <div className="container mx-auto px-6 pt-10">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 md:mt-[52px] max-w-[570px] lg:mb-0">
              <h2 className="text-dark mb-6 text-[28px] font-serif font-semibold">
                Đội ngũ RoxanaTech
              </h2>
              <p className="text-body-color mb-9 text-base leading-relaxed">
                Để lại thông tin, RoxanaTech sẽ liên hệ bạn sớm nhất có thể. Cảm
                ơn bạn đã quan tâm đến dịch vụ của chúng tôi
              </p>
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  <h4 className="text-dark mb-1 text-xl font-bold">Địa chỉ</h4>
                  <p className="text-body-color text-base">
                    292/6A Xô Viết Nghệ Tĩnh, P25, TP. Hồ Chí Minh
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="google-maps mb-20 md:mb-0">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.1146596260414!2d106.70953847590607!3d10.802529458709891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528a4d141e58f%3A0x857f569272de00dc!2zMjkyLzZBIFjDtCBWaeG6v3QgTmdo4buHIFTEqW5oLCBQaMaw4budbmcgMjUsIELDrG5oIFRo4bqhbmgsIFRow6BuaCBwaOG7kSBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1697015929876!5m2!1svi!2s"
                width="440"
                height="440"
