...
const FeaturedProductCard: React.FC<IFeaturedProductCard> = ({
  ...
  return (
      ...
      <div className="group relative cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl rounded-2xl sm:rounded-xl md:px-6 lg:px-10 w-full">
        ...
        <div className="relative z-10">
          ...
          <div className="pt-5 text-base font-semibold leading-7">
            <p>
              <a
                href="#"
                className="text-green-700 transition-all duration-300 group-hover:text-white"
              >
                Chi tiết &rarr;
              </a>
            </p>
