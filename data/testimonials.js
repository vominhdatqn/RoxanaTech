...
export const testimonials16 = [
  {
    quoteSrc: "/images/item/quote.svg",
    rating: 5,
    text: `Chúng tôi không ngừng phát triển một môi trường sáng tạo, luôn thấu hiểu khách hàng và đổi mới liên tục để mang đến những giải pháp hiện đại, bền vững. Tại đây, sự minh bạch và đạo đức kinh doanh được đặt lên hàng đầu, tạo nên niềm tin vững chắc và khẳng định giá trị thực. Chúng tôi tin rằng, sự tôn trọng và hợp tác vui vẻ chính là chìa khóa để cùng nhau mở ra cánh cửa thành công!`,
    authorImg: "/images/icon/gioi-thieu-3.png",
    authorName: "Robert Smith",
  },
  // {
  //   quoteSrc: "/images/item/quote.svg",
...
export const thumbImages = [
  {
    imgSrc: "/images/icon/gioi-thieu-4.jpg",
    alt: "image-product",
    width: 660,
    height: 490,
  },
  {
    imgSrc: "/images/icon/gioi-thieu-3.png",
    alt: "image-product",
    width: 660,
    height: 490,
  },
...
export const testimonials25 = [
  {
    ...
    rating: 5,
    review:
      "RoxanaTech đã thiết kế một website tuyệt vời cho doanh nghiệp của tôi. Giao diện đẹp, tốc độ nhanh và dễ sử dụng. Đội ngũ hỗ trợ rất chuyên nghiệp và nhiệt tình.",
    author: "Nguyễn Văn An",
    product: "Website Doanh Nghiệp",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Ứng dụng di động do RoxanaTech phát triển đã giúp công ty chúng tôi tăng doanh số bán hàng đáng kể. UI/UX được thiết kế rất tốt và phù hợp với người dùng Việt Nam.",
    author: "Trần Thị Bình",
    product: "Ứng dụng Mobile",
  ...
  },
  {
    ...
    rating: 5,
    review:
      "RoxanaTech là đối tác tin cậy trong việc phát triển website thương mại điện tử. Họ hiểu rõ nhu cầu của khách hàng và đưa ra giải pháp phù hợp nhất.",
    author: "Lê Hoàng Nam",
