...
export const products21 = [
  {
    ...
    features: [
      ...
      "Tìm kiếm cơ bản",
      "Tối ưu link",
      "Chức năng hiển thị thông tin cơ bản",
      "Hướng dẫn sử dụng",
      "Popup quảng cáo",
      "Thay đổi: màu sắc web, thông tin cửa hàng",
      "Hỗ trợ qua Teamviewer",
      "Tích hợp: Nút gọi điện, Google map, chat Facebook/Zalo",
    ],
    new: true,
  },
  {
...
export const products211 = [
  {
    ...
    price: "4.999.000",
    features: [
      "Tính năng: Website cơ bản 3",
      "Mobile / Responsive",
      "Chứng chỉ SSL",
      "Goolge dịch",
      "Giỏ hàng / Đặt lịch cơ bản",
